...
class SlackDelivery(Base):
    ...
    __table_args__ = (
        Index("ix_slack_deliveries_user_id", "user_id"),
        Index("ix_slack_deliveries_project_id", "project_id"),
        Index("ix_slack_deliveries_notification_type", "notification_type"),
        Index("ix_slack_deliveries_created_at", "created_at"),
        Index("ix_slack_deliveries_sent_at", "sent_at"),
        Index("uq_slack_deliveries_dedupe_key", "dedupe_key", unique=True),
    )
