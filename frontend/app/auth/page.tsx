        ...
        <div className="text-sm text-zinc-600 dark:text-zinc-400">
          {mode === 'login' ? (
            <>
              ...
              <button className="auth-p cursor-pointer font-semibold underline underline-offset-2 hover:text-zinc-900 dark:hover:text-zinc-100" onClick={() => setMode('signup')}>
            ...
            <>
              ...
              <button className="auth-p cursor-pointer font-semibold underline underline-offset-2 hover:text-zinc-900 dark:hover:text-zinc-100" onClick={() => setMode('login')}>
